...
public class DeleteRestauranteUsecase {
    ...
    private DeleteRestauranteUsecase(IRestauranteGateway restauranteGateway) {
        this.restauranteGateway = restauranteGateway;
    }

    public static DeleteRestauranteUsecase create(IRestauranteGateway restauranteGateway) {
        return new DeleteRestauranteUsecase(restauranteGateway);
    }
    ...
    public Integer run(Long id) {
        ...
        return this.restauranteGateway.delete(id);
    }
}
